package com.bokor.shopping.App;
...
import com.bokor.shopping.App.ui.fragment.first.MainHome;
import com.bokor.shopping.App.ui.fragment.first.child.Home;
import com.bokor.shopping.App.ui.fragment.fourth.ZhihuFourthFragment;
import com.bokor.shopping.App.ui.fragment.fourth.child.MeFragment;
import com.bokor.shopping.App.ui.fragment.second.ZhihuSecondFragment;
import com.bokor.shopping.App.ui.fragment.second.child.ViewPagerFragment;
import com.bokor.shopping.App.ui.fragment.third.ZhihuThirdFragment;
...
public class Main2Activity extends SupportActivity implements BaseMainFragment.OnBackToFirstListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportFragment firstFragment = findFragment(MainHome.class);
        if (firstFragment == null) {
            mFragments[FIRST] = MainHome.newInstance();
            ...
            public void onTabReselected(int position) {
                ...
                if (count > 1) {
                    if (currentFragment instanceof MainHome) {
                        currentFragment.popToChild(Home.class, false);
