...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
    ...
    //<editor-fold desc="Attribute variable property and variable">
    //<editor-fold desc="Sliding attribute">
    protected int mTouchSlop;
    protected int mSpinner;//current Spinner
    protected int mLastSpinner;//Last，of Spinner
    protected int mTouchSpinner;//When touched，of Spinner
    protected int mFloorDuration = 300;//Second floor expansion time
